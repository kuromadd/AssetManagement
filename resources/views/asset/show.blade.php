...
@section('content')
  ...
  <div class="card-body">
      ...
      <div class="text-center">
        <a href="{{route('transfert.create',$asset->id)}}"><i class="fa fa-paper-plane fa-fw text-blue"></i></i> transfer &#160&#160&#160</a><a href="{{route('missions.create',$asset->id)}}"><i class="fa fa-play fa-fw text-blue"></i></i> &#160&#160&#160start mission</a>                                                                 
      </div>
</div>
</div>
@endsection